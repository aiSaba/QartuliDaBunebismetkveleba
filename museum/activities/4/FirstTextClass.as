package
{
	...
	public class FirstTextClass extends MovieClip
	{
		private var firtsText:MovieClip;
		private var textBG:MovieClip;
		
		private var secondTextClass:SecondTextClass;
		...
		public function FirstTextClass(_stageWidth:Number = 1024, _stageHeight:Number = 768)
		{
		...
		private function initFirstText():void
		{
			
			firtsText = new FirstText();
			
			addChild(firtsText);
			
			firtsText.x = _stageWidth / 2;
			firtsText.y = _stageHeight / 2;
			
			firtsText.height = _stageHeight / 4;
			firtsText.scaleX = firtsText.scaleY;
			//////Arrays
			wordsArray = [firtsText.durbindi, firtsText.generals, firtsText.ekutvnoda, firtsText.xolme]
			
			//
			
			randomNumber = Math.round(Math.random() * 3);
			
			wrongwordsArray = ["დუბინდი ", "გენერას ", "ეკუთნოდა ", "ხომე "]
			...
			//
			currectwordsArray = ["დურბინდი ", "გენერალს ", "ეკუთვნოდა ", "ხოლმე "]
			
			//
			
			wordsArray1 = [firtsText.durbindi, firtsText.generals, firtsText.ekutvnoda, firtsText.xolme, firtsText.didi, firtsText.adre, firtsText.daushishrad, firtsText.gadahyurebda, firtsText.brdzolisvels]
		...
		private function textClickHandler(e:MouseEvent):void
		{
			...
			setTimeout(SecondTextCall, 2000)
		
		}
		
		private function SecondTextCall():void
		{
			dispatchEvent(new DataEvent(DataEvent.DATA, false, false, "MovrchiPirvels"));
			destroy(null);
