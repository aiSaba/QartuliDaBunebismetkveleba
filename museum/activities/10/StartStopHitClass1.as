package
{
	...
	public class StartStopHitClass1 extends MovieClip
	{
		...
		public function StartStopHitClass1(_Drag:MovieClip, _Hit:MovieClip)
		{
		...
		private function StopDragHandler(e:MouseEvent):void
		{
			...
			if (count == 4)
			{
				dispatchEvent(new DataEvent(DataEvent.DATA, false, false, "movrchiscenas"));
