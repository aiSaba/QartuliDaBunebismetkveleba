package
{
	...
	public class TeleskopiClass extends MovieClip
	{
		...
		public function TeleskopiClass(_stageHeight, _stageWidth)
		{
		...
		private function animMuseum2():void
		{
			...
			soundControl.loadSound("3.mp3", 1);
		...
		private function soundListener(e:DataEvent):void 
		{
			...
			soundControl = new SoundControl();
			addChild(soundControl);
			soundControl.loadSound("4.mp3", 1);
			soundControl.soundPlay()
