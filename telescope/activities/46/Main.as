package  {
	...
	public class Main extends MovieClip {
		...
		private var lightSupply:LightSupply;
		...
		private function callGames():void
		{
			...
			lightSupply = new LightSupply(_stageWidth, _stageHeight);
			addChild(zgarbi);
			
			zgarbi.addEventListener(DataEvent.DATA, beforeStage, false, 0, true);
			lightSupply.addEventListener(DataEvent.DATA, beforeStage, false, 0, true);
		}
